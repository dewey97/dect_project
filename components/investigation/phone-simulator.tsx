  ...
  return (
    <div className="flex flex-col gap-5 px-4 pb-10">
      ...
      <button
        ...
        className="flex items-center gap-1.5 font-mono text-[0.65rem] text-primary uppercase tracking-wider hover:-translate-x-0.5 active:scale-95 transition-all w-fit pt-2"
      >
      ...
      {/* 2. Metadata Panel (only shown at root grid list) */}
      {!activeApp && <MetadataPanel device={device} />}

      {/* 3. Reconstructed Screen Workspace */}
