    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex flex-col items-center justify-center p-0 sm:p-4 select-none overflow-hidden animate-in fade-in-50">
        ...
        <motion.div
          ...
          className="w-full h-full sm:max-w-[440px] sm:max-h-[92vh] flex flex-col overflow-hidden relative items-center justify-center p-0 sm:rounded-[36px] sm:border sm:border-[#543b27] sm:shadow-[0_25px_70px_rgba(0,0,0,0.95)]"
        >
