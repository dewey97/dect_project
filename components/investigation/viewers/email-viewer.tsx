      ...
      {!selectedEmailId ? (
        ...
        <div className="flex flex-col gap-2.5 font-sans">
          {emails.map((email) => (
            ...
            >
              <div className="flex justify-between items-start font-mono text-[0.55rem] text-muted-foreground">
              ...
              <div className="mt-2.5 pt-1.5 border-t border-border/20 flex justify-between items-center text-[0.55rem] font-mono">
                <span className={cn(
                ...
                <span className="text-emerald-500 font-medium">TOÀN VẸN: {email.integrity}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col gap-3 font-sans">
          ...
          <div className="rounded-lg border border-border bg-card/45 p-4 flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-2 border-b border-border/25 pb-3 font-mono text-[0.6rem] text-muted-foreground">
              <div>
              ...
              <div className="text-right">
                ...
                <span className="block mt-0.5 text-emerald-500 font-medium">ĐÃ_KIỂM_TRA_TOÀN_VẸN_OK</span>
              </div>
            </div>
