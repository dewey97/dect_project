...
export const checkpoints000: Checkpoint[] = [
  {
    ...
    options: [
      ...
      'Nạn nhân bị đâm chết tại chỗ ngay từ 18:30 khi cãi vã với Mai; hàng xóm nghe nhầm tiếng động và chỉ cần triệu tập Nguyễn Ngọc Mai.',
  ...
  },
  {
    ...
    hint: 'Đối chiếu ngày giỗ tròn 20 năm bé Gia Huy (24/07/1996 - 24/07/2016), lời tự thú của Tùng lúc 20:15 và mốc giờ tàu hàng chạy qua lúc 20:30.',
    options: [
      'Ngày giỗ 20 năm bé Gia Huy tử vong trong tủ gỗ năm 1996; Tùng xô Khang ngã ngất lúc 20:00 nhưng Khang vẫn thở đều, Tùng bỏ đi lúc 20:15 trước khi tàu hàng 20:30 chạy qua.',
    ...
    correctAnswer: 'Ngày giỗ 20 năm bé Gia Huy tử vong trong tủ gỗ năm 1996; Tùng xô Khang ngã ngất lúc 20:00 nhưng Khang vẫn thở đều, Tùng bỏ đi lúc 20:15 trước khi tàu hàng 20:30 chạy qua.',
  ...
  },
  {
    ...
    options: [
      ...
      'Hung thủ: Nguyễn Ngọc Mai. Đơn tố cáo đòi đất 200m² & Dấu vân tay trên bình trà.'
    ],
