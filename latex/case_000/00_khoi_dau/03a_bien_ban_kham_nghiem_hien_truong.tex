...
\vspace{0.3cm}\noindent\textbf{\large Chúng tôi gồm:}\\[0.15cm]
...
\vspace{0.3cm}\noindent\textbf{\large I. MÔ TẢ HIỆN TRƯỜNG CHUNG}\\[0.15cm]
...
\vspace{0.3cm}\noindent\textbf{\large II. MÔ TẢ TỬ THI TẠI HIỆN TRƯỜNG}\\[0.15cm]
...
\vspace{0.3cm}\noindent\textbf{\large III. DẤU VẾT VÀ VẬT CHỨNG THU THẬP ĐƯỢC TẠI HIỆN TRƯỜNG}\\[0.15cm]
