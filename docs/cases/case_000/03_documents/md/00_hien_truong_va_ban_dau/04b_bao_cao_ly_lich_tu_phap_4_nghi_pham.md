...
# BÁO CÁO RÀ SOÁT LÝ LỊCH TƯ PHÁP 04 ĐỐI TƯỢNG NGHI VẤN
*(Chuyên án #000 — Vụ án mạng tại số 14 Đường Bờ Sông)*

---

### BẢNG TRÍCH LỤC LÝ LỊCH CĂN CƯỚC & PHƯƠNG TIỆN LIÊN LẠC
...
│ • Quan hệ: Em họ nạn nhân Khang; Vợ của Lê Quang Vũ.                        │
├─────────────────────────────────────────────────────────────────────────────┤
│ 2. LÊ QUANG VŨ                                                              │
├─────────────────────────────────────────────────────────────────────────────┤
...
│ • Tiền án, tiền sự: Không. (Hồ sơ tâm lý có biểu hiện ái kỷ và cuồng yêu).  │
│ • Quan hệ: Bạn gái sống gần nhà (quan hệ tình cảm phức tạp 3 năm với Khang).│
└─────────────────────────────────────────────────────────────────────────────┘
```
