...
# SƠ ĐỒ MẶT BẰNG HIỆN TRƯỜNG PHÒNG KHÁCH
*(Hiện trường vụ án mạng: Số 14 Đường Bờ Sông, Phân khu Cảng)*

---

### I. BẢN VẼ SƠ ĐỒ MẶT BẰNG PHÒNG KHÁCH (TỶ LỆ 1:50)

```text
                                [ HƯỚNG BẮC - ĐƯỜNG BỜ SÔNG ]
                                              │
    ┌───────────────────────────[ CỔNG SẮT NGOÀI NGÕ ]───────────────────────────┐
    │                                                                           │
    │   ┌───────────────────────[ CỬA CHÍNH (GỖ 2 CÁNH) ]───────────────────┐   │
    │   │                                                                   │   │
    │   │    [p2] Đơn tố cáo đất 200m²                                      │   │
    │   │    (Rơi xòe quạt gần cửa)                                         │   │
    │   │                                                                   │   │
    │   │                 ┌───────────────────────────────┐                 │   │
    │   │                 │        BÀN TRÀ GỖ DÀI         │                 │   │
    ...
    │   │                  ░                          ░                     │   │
    │   │                  ░   [p3] HUNG KHÍ THỦY TINH░                     │   │
    │   │                  ░   (cách cổ nạn nhân 25cm)░                     │   │
    │   │                  ░                          ░                     │   │
    │   │                  ░   [ TỬ THI NẠN NHÂN ]    ░                     │   │
    │   │                  ░   (Nằm sấp úp mặt)       ░                     │   │
    │   │                  ░   [dev-00] iPhone        ░                     │   │
    ...
    │   │                                                                   │   │
    │   │   ┌───────────────────────┐                                       │   │
    │   │   │   TỦ GỖ ÂM TƯỜNG      │        [ CỬA NÁCH RA SÂN SAU ] ───────┘   │
    │   │   │ • [10a] Sổ nợ da đen  │        (Then cài trong bị gạt mở)         │
    │   │   └───────────────────────┘                                           │
    └───┴───────────────────────────────────────────────────────────────────────┘
                                              │
                                [ HƯỚNG NAM - KHOẢNG SÂN SAU ]
```

---

### II. CHÚ GIẢI KHOẢNG CÁCH VÀ VỊ TRÍ CÁC VẬT CHỨNG TRỌNG YẾU
...
**CÁN BỘ ĐO VẼ HIỆN TRƯỜNG**  
*(Ký, ghi rõ họ tên)*  
**Trung úy Phạm Thanh — PC09**
