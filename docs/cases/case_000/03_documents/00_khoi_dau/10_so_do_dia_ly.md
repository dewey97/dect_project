...
# SƠ ĐỒ MẠNG LƯỚI ĐỊA LÝ & BẢNG TÍNH CỰ LY DI CHUYỂN
*(Phục vụ kiểm tra tính xác thực của các bằng chứng ngoại phạm)*

---

### I. SƠ ĐỒ KHÔNG GIAN ĐỊA BÀN CHUYÊN ÁN #000

```text
                [ PHÂN KHU CẦU CẢNG - KHU QUÁN BIA VEN SÔNG ]
                • Quán Bia hơi 88 (Lê Quang Vũ thanh toán CK lúc 20:45)
                                  │
                                  │  (3.8 km - Tuyến đường ven sông)
                                  │
                                  ▼ (Xe ôm trong mưa: ~10-12 phút)
┌─────────────────────────────────────────────────────────────────────────────┐
...
│                                                   [Phòng Trọ Trần Thị Hà]   │
│                                                   (Số 8 Ngõ 12 Bờ Sông)     │
└──────────────────────────────────────┬──────────────────────────────────────┘
                                       │
                                       │ (4.0 km - Tuyến đường trục nội đô)
                                       ▼
┌─────────────────────────────────────────────────────────────────────────────┐
│                    PHÂN KHU PHỐ ĐOÀN KẾT (KHU ĐÔ THỊ NỘI THÀNH)             │
│                                                                             │
│  • Nhà riêng vợ chồng Mai & Vũ (Số 45 Phố Đoàn Kết)                         │
│    - Mai về nhà: 19:45 (Xem tivi đến 20:10 thì mất sóng cáp)                 │
│  • Đầu ngõ: Bảng tin khu phố (Thông báo sự cố đứt cáp truyền hình lúc 20:10)│
└─────────────────────────────────────────────────────────────────────────────┘
```
