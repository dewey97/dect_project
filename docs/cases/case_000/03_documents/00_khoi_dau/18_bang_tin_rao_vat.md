...
### I. BỐI CẢNH THU THẬP & MỤC ĐÍCH NGHIỆP VỤ
* **Bối cảnh:** Nạn nhân Nguyễn Văn Khang làm nghề cho vay nặng lãi, bốc họ và có nhiều tranh chấp xã hội phức tạp.
* **Mục đích:** Khám nghiệm ngoại cảnh xung quanh khu vực cổng và bờ tường rào nhà nạn nhân nhằm ghi nhận các dấu vết đe dọa, xịt sơn khủng bố đòi nợ của các đối tượng mâu thuẫn bên ngoài để phục vụ công tác rà soát diện tình nghi.

---

### II. NỘI DUNG GHI NHẬN TRÊN BỜ TƯỜNG & BẢNG TIN DÂN CƯ

```text
┌─────────────────────────────────────────────────────────────────────────────┐
│                    BỜ TƯỜNG RÀO & BẢNG TIN ĐẦU NGÕ NHÀ KHANG                │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
│ ─────────────────────────────────────────────────────────────────────────── │
│                                                                             │
│   [CÁC MẨU THÔNG BÁO & TỜ RƠI DÁN TRÊN BẢNG TIN GỖ CẠNH CỔNG]:              │
│                                                                             │
│   [MẨU 1 - GIẤY VIẾT TAY DÁN BĂNG DÍNH TRONG SUỐT GÓC BẢNG TIN]             │
│   ┌─────────────────────────────────────────────────────────────────────┐   │
...
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
│   [MẨU 2 - THÔNG BÁO CỦA TỔ DÂN PHỐ]                                        │
│   ┌─────────────────────────────────────────────────────────────────────┐   │
│   │ THÔNG BÁO SỰ CỐ TÍN HIỆU TRUYỀN HÌNH CÁP & MẠNG INTERNET            │   │
│   │ Ban Quản lý Tổ dân phố thông báo: Do đơn vị thi công đào rãnh cáp   │   │
│   │ ngầm sơ suất làm đứt tuyến cáp quang nhánh Bờ Sông – Đoàn Kết lúc   │   │
│   │ khoảng 20h10 tối 24/07, gây mất tín hiệu tivi và mạng internet toàn │   │
│   │ khu vực đến sáng 25/07. Kính báo bà con nhân dân được biết.         │   │
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
│   [MẨU 3 - THÔNG BÁO CỦA TỔ DÂN PHỐ VỀ THU GOM RÁC ĐƯỜNG TÀU]               │
│   ┌─────────────────────────────────────────────────────────────────────┐   │
│   │ TỔ DÂN PHỐ SỐ 4 — THÔNG BÁO V/V THU GOM RÁC THẢI SINH HOẠT         │   │
│   │ Do xe rác thường xuyên bị kẹt tại nút giao cắt đường sắt lúc hạ rào │   │
│   │ chắn, Tổ dân phố điều chỉnh giờ gom rác ngõ Bờ Sông như sau:        │   │
│   │ • Thu gom từ 19h30 đến 20h15 (kết thúc trước khi gác chắn đóng đón  │   │
│   │   chuyến tàu hàng Bắc – Nam lúc 20h30 hàng đêm).                    │   │
│   │ • Đề nghị bà con không vứt rác ra đường ray sau 20h15 để đảm bảo an │   │
│   │   toàn giao thông đường sắt. Kính báo!                              │   │
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
│   [MẨU 4 - RAO VẶT KHÁC]                                                    │
│   • Cho thuê phòng trọ khép kín ngõ 12 Bờ Sông (LH: Bác Lụa - 0978.123.xxx) │
│   • Khoan cắt bê tông - Hút bể phốt giá rẻ (LH: 0904.xxx.xxx)               │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
