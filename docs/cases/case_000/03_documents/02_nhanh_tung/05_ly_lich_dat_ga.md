...
# BẢN TRÍCH LỤC HỒ SƠ LÝ LỊCH & XÁC MINH NGOẠI PHẠM
*(Mã đối tượng: `PERSON-DAT-GA` — Tra cứu theo SĐT `0912.331.888`)*

---

```text
┌─────────────────────────────────────────────────────────────────────────────┐
│ HỒ SƠ LÝ LỊCH TRÍCH LỤC: TRẦN VĂN ĐẠT (ĐẠT GÀ CHỢ CẢNG)                    │
├─────────────────────────────────────────────────────────────────────────────┤
...
│ • KẾT LUẬN: Đạt Gà có bằng chứng ngoại phạm khách quan vững chắc (Nhiễu).    │
└─────────────────────────────────────────────────────────────────────────────┘
```

---

**ĐIỀU TRA VIÊN XÁC MINH**  
*(Ký tên)*  
