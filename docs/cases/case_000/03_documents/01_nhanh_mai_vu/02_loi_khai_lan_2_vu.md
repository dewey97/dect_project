...
* **Hỏi (ĐTV Lê Minh):** Chúng tôi đã có trong tay dữ liệu:
  ...
  3. Cuốn sổ nợ của Khang ghi rõ con nợ `Thằng Lệch Pha` nợ `300.000.000đ` (SĐT `0967.452.183` — chúng tôi đã xác minh đây là số điện thoại thứ hai đăng ký dưới tên anh, đồng thời chữ ký trong sổ nợ tương đồng so với chữ ký của anh trong biên bản lấy lời khai đầu tiên; và biệt danh `Lệch Pha` trong sổ nợ trùng khớp với biệt danh Khang gọi anh trong các tin nhắn SMS gửi đến số `0988.20.09.91`).
