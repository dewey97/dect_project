...
\begin{enumerate}[label=\arabic*., leftmargin=1.5cm]
    ...
    \item \textbf{Dấu vết xáo trộn \& Vật chứng rơi vỡ:} Bộ bình cốc thủy tinh uống trà bị đập vỡ vụn dưới sàn nhà gần mép bàn trà. Cạnh đó phát hiện 01 khung ảnh gỗ ố vàng bị đập vỡ, mặt kính nứt rạn nhiều đường, chứa bức ảnh cũ được cho là Cụ Thành đang bế Khang chụp cùng những đứa trẻ hàng xóm (ký hiệu vật chứng \texttt{p4}).
    ...
    \item \textbf{Dấu vết đồ đạc:} Tủ âm tường gỗ ở góc phòng bị xê dịch. Khóa khoang tủ sắt bên trong bị cạy phá xới tung. Nhiều tập hồ sơ giấy tờ văng vãi khắp sàn nhà gồm: bản vẽ địa chính, tờ di chúc viết tay, các sổ sách ghi chép thu họ/cho vay cá nhân, giấy tờ đất đai đền bù dự án, cùng một số mảnh bài báo cũ và ảnh kỷ niệm cá nhân (ký hiệu vật chứng \texttt{p2}).
\end{enumerate}

\section*{III. DANH MỤC VẬT CHỨNG THU THẬP NỘP KHO}
\begin{enumerate}[label=\arabic*., leftmargin=1.5cm]
    \item 01 Mảnh thủy tinh sắc nhọn dính máu khô (ký hiệu vật chứng \texttt{p3}).
    \item 01 Khung ảnh gỗ bị đập vỡ, mặt kính nứt rạn chứa bức ảnh được cho là Cụ Thành bế Khang chụp cùng những đứa trẻ hàng xóm năm 1998 (ký hiệu vật chứng \texttt{p4}).
    \item 01 Mẫu máu khô và mẫu dấu giày nam size 41 thu tại khu vực bàn trà.
    \item Các tập hồ sơ giấy tờ, sổ sách thu họ, giấy tờ đất đai đền bù, di chúc và hình ảnh kỷ vật vương vãi dưới sàn phòng khách (ký hiệu vật chứng \texttt{p2}).
\end{enumerate}
