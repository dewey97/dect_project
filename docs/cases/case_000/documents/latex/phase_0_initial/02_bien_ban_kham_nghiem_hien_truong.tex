...
\begin{enumerate}[label=\arabic*., leftmargin=1.5cm]
    ...
    \item \textbf{Vật chứng kim loại dưới chân bàn:} Thu giữ 01 chiếc **Ghim cài áo (Huy hiệu nhận diện công ty xây dựng)** bằng đồng dính bụi vôi vữa rơi sát chân bàn trà (ký hiệu vật chứng \texttt{p8}).
    ...
    \item \textbf{Dấu vết đồ đạc \& Giấy tờ văng vãi:} Tủ âm tường gỗ ở góc phòng bị xê dịch. Khóa khoang tủ sắt bên trong bị cạy phá xới tung. Nhiều tập hồ sơ giấy tờ văng vãi gồm: bản vẽ địa chính, tờ di chúc viết tay, các sổ sách thu họ, cùng hóa đơn nạp tiền số \texttt{0985.xxx.341} tên \texttt{LE QUANG VU}.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*., leftmargin=1.5cm]
    ...
    \item Các tập hồ sơ giấy tờ, sổ sách thu họ, giấy tờ đất đai đền bù, di chúc (ký hiệu \texttt{p2}).
