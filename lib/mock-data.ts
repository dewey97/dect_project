...
export const CASES: Case[] = [
  {
    ...
    briefing: 'Liệu bí mật nào đang ẩn sau cái chết của Khang. Trò chơi trốn tìm có liên quan gì? Hãy bóc tách từng manh mối nhỏ nhất để tìm ra lời giải cho vụ án hóc búa này.',
...
export const DEVICES: Device[] = [
  {
    ...
    caseId: 'case-000',
    kind: 'phone',
    label: 'Điện thoại iPhone 6s Plus của Khang',
    ...
    description: 'Thiết bị liên lạc cá nhân iPhone 6s Plus (pin còn 18%) thu giữ tại hiện trường vụ án, rơi úp mặt gần bàn tay phải nạn nhân.',
